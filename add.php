...
<body>
    ...
    <a href="index.php" class="bg-gray-700 hover:bg-gray-600 p-3 text-white rounded shadow-lg">Go to Home</a>
    <br /><br />
    ...
    <form action="add.php" method="post" name="form1">
        <table width="25%" border="0">
            ...
            <tr>
                <td></td>
                <td><input type="submit" name="Submit" value="Add" class="bg-gray-700 hover:bg-gray-600 p-3 text-white rounded shadow-lg cursor-pointer"></td>
            </tr>
        </table>
    </form>
    ...
    if (isset($_POST['Submit'])) {
        ...
        echo "User added successfully. <a href='index.php' class='bg-green-700 hover:bg-green-600 p-3 text-white rounded shadow-lg'>View Users</a>";
    }
    ?>
    </div>
